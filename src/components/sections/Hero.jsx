  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col items-center text-center">
        ...
        <div
          ref={ctaGroupRef}
          className="w-full sm:w-auto flex flex-row items-center justify-center gap-2 sm:gap-4 mt-4 sm:mt-6 pt-1 max-w-full"
        >
          {/* Primary CTA: Explore Services */}
          <a
            href="#services"
            onClick={handlePrimaryCtaClick}
            className="w-auto min-h-[42px] sm:min-h-[48px] inline-flex items-center justify-center gap-1.5 sm:gap-2.5 px-4 sm:px-8 py-2 sm:py-3.5 rounded-full bg-[#0072CE] hover:bg-[#005FA8] active:bg-[#005FA8] text-white font-bold text-xs sm:text-base shadow-md sm:shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/35 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300 group focus:outline-none focus:ring-2 focus:ring-[#0072CE] focus:ring-offset-2 shrink-0"
          >
            <span className="whitespace-nowrap">Explore Services</span>
            <span className="w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-white/20 flex items-center justify-center text-white group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform duration-200 shrink-0">
              <svg className="w-2.5 h-2.5 sm:w-3 sm:h-3 fill-current" viewBox="0 0 20 20" aria-hidden="true">
                <path
                  fillRule="evenodd"
          ...
          <button
            ...
            className="w-auto min-h-[42px] sm:min-h-[48px] inline-flex items-center justify-center sm:justify-start gap-2 sm:gap-3 px-3.5 sm:px-5 py-1.5 sm:py-2.5 rounded-full border border-slate-200/90 dark:border-slate-800 bg-white/90 dark:bg-slate-900/90 hover:bg-[#F0F7FD] dark:hover:bg-slate-800/80 transition-all duration-200 group text-left shadow-xs cursor-pointer shrink-0"
            aria-label="Open SIRI Group Consultation Desk"
          >
            <span className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[#F0F7FD] dark:bg-slate-800 border border-blue-100 dark:border-slate-700 flex items-center justify-center text-[#0072CE] group-hover:scale-105 transition-transform shrink-0">
            ...
            <div className="flex flex-col items-start leading-tight">
              ...
              <span className="text-xs sm:text-sm font-extrabold text-[#1E293B] dark:text-slate-100 group-hover:text-[#0072CE] transition-colors whitespace-nowrap">
                Consultation Desk
              </span>
            </div>
          </button>
              ...
              <div className="relative w-24 h-24 sm:w-28 sm:h-28 lg:w-32 lg:h-32 rounded-full bg-white shadow-2xl shadow-blue-950/20 border-2 border-[#002D62]/20 flex items-center justify-center p-1 backdrop-blur-xl ring-2 ring-white/90">
                ...
                >
                  ...
                  <text className="text-[10px] sm:text-[9.5px] lg:text-[9px] font-black uppercase tracking-[0.12em] fill-[#002D62]">
                    ...
                    >
                      ✦ SIRI GROUP ✦ 5+ SERVICES ✦ ONE PARTNER
                    </textPath>
                  </text>
                </svg>
